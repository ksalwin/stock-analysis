...
This script is used to plot the SMA and signals from a file generated by 0_generate_signals.py.

Usage:
./plot_sma_and_signals.py --sma-short 20 --sma-long 100 --from-date "2024-01-01" results.csv
"""
